...
$admin_email = mysqli_real_escape_string($con,$res['email_id']);                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  $admin_email = mysqli_real_escape_string($con,$res['email_id']);
...
<footer class="footer">
  ...
  <div class="container">
    ...
    <div class="footer-content col-lg-3 col-md-3 col-sm-3 col-sm-4 col-lg-4">
      ...
      <li><a href="<?php
echo $site_url ;
?>/users/contact.php">Contact Us</a></li>
        <li><a href="<?php
echo $res['site_url'];
?>">Accueil</a></li>
        <li><a href="<?php
...
?>/img/app2.png"></a>
    ...
    <div class="footer-content col-lg-3 col-md-3 col-sm-3 col-sm-4 col-lg-4">
      <div class="footer-content__social social">
          <h5 class="footer-content__title">Online</h5>
